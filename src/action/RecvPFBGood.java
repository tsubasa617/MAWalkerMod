...
public class RecvPFBGood {
	...
	// private static final String URL_FAIRY_HISTORY =
	// "http://web.million-arthurs.com/connect/app/private_fairy/private_fairy_history?cyt=1";
	...
	public static boolean run() throws Exception {
		...
		try {
			...
			al.add(new BasicNameValuePair("serial_id",
	...
	private static boolean parse(Document doc) throws Exception {
		...
		try {
			...
			if ((boolean) xpath
				...
				ErrorData.currentErrorType = ErrorData.ErrorType.RecvPFBGoodResponse;
				ErrorData.currentDataType = ErrorData.DataType.text;
				ErrorData.text = String.format("%s收赞回复%s点BC...", msg, add);
			}
		} catch (Exception ex) {
