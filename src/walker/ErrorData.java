...
/**
 * 处理内部错误，在execute时，如果是run所捕获的错误，则放入此类中。<br/>
 * 这样，当execute捕获到错误时，首先检查此类中有无存放错误信息，<br/>
...
public class ErrorData {
	...
	public enum ErrorType {
		...
		// 取箱
		GetRewardBoxDataError, GetRewardBoxResponse,
		// 卖卡
		SellCardDataError, SellCardResponse,
		// 升级
		LvUpDataError, LvUpResponse,
		// 赞
		PFB_GoodDataError, PFB_GoodResponse,
		// fairy_history
